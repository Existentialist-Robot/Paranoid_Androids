...
#    return render(request, 'search/search_home.html', {'filter': meta_filter})

#def home(request): # going to have to include the search parameters here as a form
#    meta_list = Metadata.objects.all()
#    meta_filter = filters.MetadataFilter(request.GET, queryset=meta_list).qs
#    paginator = Paginator(meta_filter, 9)
...
#    return render(request, 'search/search_home.html', {'response': response},{'filter': meta_filter})
